    ...
    render() { return (
        <form role="form" id="regForm" >
            <div className="form-group">
                ...
                ref={(node) => { this.accountName = node }} required />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
                ...
                <input type="text" name="phone" placeholder="Phone..." className="form-control" id="email" pattern="\d{3}-\d{3}-\d{4}"
                title="Phone number should be format of 123-123-1234" 
                ref={(node) => { this.phone = node }} required />
            </div>
            <div className="form-group">
                <label className="sr-only">Date of Birth</label>
                <input type="Date" id="bday" name="bday" 
                        placeholder="Date of birth..." className="form-control" 
                        ref={(node) => { this.bday = node }} required />
            </div>
            <div className="form-group">
